...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-green-800 text-neutral-content flex flex-col md:flex-row">
            <div className='md:w-1/2'>
                <aside>
                    ...
                    <p className="font-bold">
                        Banu & Haque Homes Ltd. <br />Providing reliable tech since 1992
                    </p>
            ...
            <div className='md:w-1/2 px-5'>
                <h1 className='font-bold text-xl'>Send Message</h1>
                <input type="text" className='w-full md:w-1/2 p-2'placeholder='Enter Subject'/>
                <textarea className='p-2' cols="47" rows="5" placeholder='Enter Message'></textarea>
                <button className='btn w-1/2'>Send</button>
            </div>
        </footer>
    );
};
